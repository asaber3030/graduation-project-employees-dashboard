...
export const AdminSidebar = () => {
  ...
  return (
    <aside className={cn("bg-[#111] h-screen border-r border-r-[#222] p-2 w-80 overflow-auto scrollbar-thumb-gray-300 scrollbar-track-gray-100 scrollbar-thin hidden xl:flex xl:justify-between xl:flex-col md:block", sidebarState && "w-20 overflow-hidden")}>
        ...
        <section>
          ...
          <div className='mt-4'>
            ...
            {permissions.map((group) => (
              <AdminSidebarItem key={group.id} label={group.groupName} url={group.groupUrl} icon={resourcesIcons[group.groupIcon as keyof typeof resourcesIcons]} />
            ))}
          </div>
        </section>
      </div>
